    ...
    return (
        <div className="container-fluid">
            <header className="text-center mt-2 p-2 header row">
                ...
                <input className="search-input col-4" type="text" placeholder="Search"></input>
            </header>
            <section className="mt-2 p-2 row">
                <BrowserRouter>
                    <nav className="col-3">
                        <div className="col-12 btn mt-2 p-2 links">
                            <Link to="/Companies"><h6> Companies</h6></Link>
                        </div>
                        <div className="col-12 btn  mt-2 p-2 links">
                            <Link to="/Applied"><h6>Applied Companies</h6></Link>
                        </div>
                        <div className="col-12 btn  mt-2 p-2 links">
                            <Link to="/ShareHrContact"><h6>ShareHrContact</h6></Link>
                        </div>
                        <div className=" col-12 btn  mt-2 p-2 links">
                            <Link to="/MyHrList"><h6>MyHrList</h6></Link>
                        </div>
                        <div className="col-12 btn mt-2 p-2 links">
                            <Link to="/HrList"><h6>HRList</h6></Link>
                        </div>
                        <div className="col-12 btn mt-2 p-2 links">
